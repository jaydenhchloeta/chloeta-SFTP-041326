module "sftp_network" {
  source = "github.com/jaydendh/terraform-modules//azure/sftp_network?ref=main"
...
module "sftp_security" {
  source = "github.com/jaydendh/terraform-modules//azure/sftp_security?ref=main"
...
module "sftp_vms" {
  source = "github.com/jaydendh/terraform-modules//azure/sftp_vms?ref=main"
