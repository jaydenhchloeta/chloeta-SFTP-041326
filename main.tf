module "sftp_network" {
  source = "github.com/jaydendh/chloeta-SFTP-terraform-module//sftp_network?ref=main"
...
module "sftp_security" {
  source = "github.com/jaydendh/chloeta-SFTP-terraform-module//sftp_security?ref=main"
...
module "sftp_vms" {
  source = "github.com/jaydendh/chloeta-SFTP-terraform-module//sftp_vms?ref=main"
